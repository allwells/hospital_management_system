...
public class addReceptionist extends javax.swing.JFrame {
    ...
    private void addRecptionist() {
        try {
            String query = "INSERT INTO `receptionist`(`ID`, `Firstname`, `Lastname`, `DOB`, `Gender`, `Status`,"
                    ...
                    + dob.getText() + "', '" + gender.getSelectedItem() + "', '" + status.getSelectedItem() + "',"
                    + " '" + date.getText() + "', '" + address.getText() + "', '" + email.getText() + "',"
                    + " '" + phone.getText() + "', '" + username.getText() + "', '" + receptionist_password + "')";
    ...
    private void initComponents() {
        ...
        mainLayout.add(icon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 50, 50));
        ...
        mainLayout.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 80, 30));
        ...
        mainLayout.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, 30, 30));
        ...
        mainLayout.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 10, 30));
        ...
        mainLayout.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 390, 30, 30));
        ...
        mainLayout.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, 10, 30));
        ...
        mainLayout.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 350, 10, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(mainLayout, javax.swing.GroupLayout.PREFERRED_SIZE, 1090, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
