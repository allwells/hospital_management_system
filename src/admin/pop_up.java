...
//                JOptionPane.showMessageDialog(null, "Account deletion failed!", "Message", 0);
            }
            con.close();
    ...
    private void initComponents() {
        ...
        jPanel2.add(closeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(328, 0, 32, 30));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 360, 30));

        noBtn.setBackground(new java.awt.Color(250, 250, 250));
        noBtn.setFont(new java.awt.Font("Verdana", 1, 14)); // NOI18N
        noBtn.setForeground(new java.awt.Color(100, 100, 100));
        noBtn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        noBtn.setText("No");
        noBtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(32, 178, 170)));
        ...
        yesBtn.setBackground(new java.awt.Color(250, 250, 250));
        yesBtn.setFont(new java.awt.Font("Verdana", 1, 14)); // NOI18N
        yesBtn.setForeground(new java.awt.Color(100, 100, 100));
        yesBtn.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        yesBtn.setText("Yes");
        yesBtn.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(32, 178, 170)));
    ...
    private void yesBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yesBtnMouseEntered
        yesBtn.setBackground(new Color(32, 178, 170));
        yesBtn.setForeground(new Color(250, 250, 250));
    ...
    private void yesBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_yesBtnMouseExited
        yesBtn.setBackground(new Color(250, 250, 250));
        yesBtn.setForeground(new Color(100, 100, 100));
    ...
    private void noBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noBtnMouseEntered
        noBtn.setBackground(new Color(32, 178, 170));
        noBtn.setForeground(new Color(250, 250, 250));
    ...
    private void noBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noBtnMouseExited
        noBtn.setBackground(new Color(250, 250, 250));
        noBtn.setForeground(new Color(100, 100, 100));
