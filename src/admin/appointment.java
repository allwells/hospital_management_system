...
public class appointment extends javax.swing.JFrame {
    ...
    private void setAppointment() {
        try {
            ...
            String sqlite = "INSERT INTO `appointment`(`Doctor`, `Visitor`, `Gender`,"
                    + " `Phone`, `Ward`, `Date`, `Time`) "
                    + "VALUES ('" + doc.getText() + "', '" + name.getText() + "', '" + gender.getSelectedItem() + "',"
                    + "', '" + phone.getText() + "', '" + ward.getText() + "',"
    ...
    private void view_appointmentMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_view_appointmentMouseEntered
        view_appointment.setForeground(new Color(200, 200, 200));
