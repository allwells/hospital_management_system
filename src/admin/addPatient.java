...
public class addPatient extends javax.swing.JFrame {
    ...
    private void addPatient() {
        try {
            String query = "INSERT INTO `patient`(`ID`, `Firstname`, `Lastname`, `DOB`, `Gender`, `Status`,"
                    + " `Date`, `Address`, `City`, `Phone`, `PatientType`, `Ward`, `Bed`)"
                    + " VALUES ('" + id.getText() + "', '" + fname.getText() + "', '" + lname.getText() + "', '" + dob.getText() + "',"
                    + " '" + gender.getSelectedItem() + "', '" + status.getSelectedItem() + "', '" + date.getText() + "',"
                    + " '" + address.getText() + "', '" + city.getText() + "', '" + phone.getText() + "',"
                    + " '" + type.getSelectedItem() + "', '" + ward.getText() + "', '" + bed.getText() + "')";
            db();
    ...
    private void initComponents() {
        ...
        addPat.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        ...
        delPat.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        ...
        mainLayout.add(crossoverPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, -1, 40));

        viewPat.setBackground(new java.awt.Color(250, 250, 250));
        viewPat.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        ...
        upPat.setFont(new java.awt.Font("Verdana", 1, 13)); // NOI18N
        ...
        mainLayout.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 80, 30));

        fname.setBackground(new java.awt.Color(245, 245, 245));
        fname.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        fname.setBorder(null);
        mainLayout.add(fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 330, 30));

        jLabel2.setBackground(new java.awt.Color(32, 178, 170));
        jLabel2.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(100, 100, 100));
        jLabel2.setText("Last Name");
        mainLayout.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 150, 80, 30));

        lname.setBackground(new java.awt.Color(245, 245, 245));
        lname.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        lname.setBorder(null);
        mainLayout.add(lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 180, 330, 30));
        ...
        mainLayout.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 200, 30));

        dob.setBackground(new java.awt.Color(245, 245, 245));
        dob.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        dob.setBorder(null);
        mainLayout.add(dob, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 330, 30));
        ...
        mainLayout.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 220, 60, 30));

        date.setBackground(new java.awt.Color(245, 245, 245));
        date.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        date.setBorder(null);
        mainLayout.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 320, 330, 30));
        ...
        mainLayout.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 220, 100, 30));
        ...
        mainLayout.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 290, 140, 30));
        ...
        mainLayout.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 290, 60, 30));

        address.setBackground(new java.awt.Color(245, 245, 245));
        address.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        address.setBorder(null);
        mainLayout.add(address, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, 330, 30));
        ...
        mainLayout.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 360, 30, 30));

        jLabel9.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(74, 179, 175));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("(For Indoor Patient Only)");
        mainLayout.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 510, 160, 30));

        phone.setBackground(new java.awt.Color(245, 245, 245));
        phone.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        phone.setBorder(null);
        mainLayout.add(phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 390, 330, 30));
        ...
        mainLayout.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, 80, 30));
        ...
        mainLayout.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 90, 30));
        ...
        mainLayout.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 550, 70, 30));

        ward.setBackground(new java.awt.Color(245, 245, 245));
        ward.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        ward.setBorder(null);
        mainLayout.add(ward, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 580, 150, 30));
        ...
        mainLayout.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 550, 60, 30));

        bed.setBackground(new java.awt.Color(245, 245, 245));
        bed.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        bed.setBorder(null);
        mainLayout.add(bed, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 580, 150, 30));

        city.setBackground(new java.awt.Color(245, 245, 245));
        city.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        city.setBorder(null);
        mainLayout.add(city, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 390, 330, 30));
        ...
        mainLayout.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 460, 340, 30));

        gender.setBackground(new java.awt.Color(245, 245, 245));
        gender.setFont(new java.awt.Font("Verdana", 0, 13)); // NOI18N
        gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Other" }));
        mainLayout.add(gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 250, 160, 30));
        ...
        mainLayout.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 250, 160, 30));
        ...
        mainLayout.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(104, 100, 90, 30));
        ...
        mainLayout.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 100, 30, 30));

        jSeparator2.setBackground(new java.awt.Color(32, 178, 170));
        jSeparator2.setForeground(new java.awt.Color(32, 178, 170));
        mainLayout.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 1370, 10));
        ...
        mainLayout.add(add, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 460, 340, 30));
        ...
        footer.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 0, 160, 40));
        ...
        mainLayout.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 320, 10, 30));

        jLabel17.setBackground(new java.awt.Color(245, 245, 245));
        jLabel17.setOpaque(true);
        mainLayout.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 390, 10, 30));

        jLabel18.setBackground(new java.awt.Color(245, 245, 245));
        jLabel18.setOpaque(true);
        mainLayout.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, 10, 30));

        jLabel19.setBackground(new java.awt.Color(245, 245, 245));
        jLabel19.setOpaque(true);
        mainLayout.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, 10, 30));

        jLabel20.setBackground(new java.awt.Color(245, 245, 245));
        jLabel20.setOpaque(true);
        mainLayout.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 10, 30));

        jLabel21.setBackground(new java.awt.Color(245, 245, 245));
        jLabel21.setOpaque(true);
        mainLayout.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 580, 10, 30));

        jLabel22.setBackground(new java.awt.Color(245, 245, 245));
        jLabel22.setOpaque(true);
        mainLayout.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 100, 10, 30));

        jLabel23.setBackground(new java.awt.Color(245, 245, 245));
        jLabel23.setOpaque(true);
        mainLayout.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 10, 30));

        jLabel24.setBackground(new java.awt.Color(245, 245, 245));
        jLabel24.setOpaque(true);
        mainLayout.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 580, 10, 30));

        jLabel25.setBackground(new java.awt.Color(245, 245, 245));
        jLabel25.setOpaque(true);
        mainLayout.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 10, 30));
