...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        admin_ico_bg = new javax.swing.JLabel();
        doc_ico_bg = new javax.swing.JLabel();
        recep_ico_bg = new javax.swing.JLabel();
        ...
        loginIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/login.png"))); // NOI18N
        ...
        adminIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/admin_ico.png"))); // NOI18N
        ...
        mainLayout.add(adminIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, -1, 60));

        docIcon.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        docIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/doctor_ico.png"))); // NOI18N
        ...
        mainLayout.add(docIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, 50, 60));
        ...
        recepIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/receptionist_ico.png"))); // NOI18N
        ...
        mainLayout.add(recepIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 180, 50, 60));
        ...
        admin_ico_bg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        admin_ico_bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/circle_bg_green_02.png"))); // NOI18N
        admin_ico_bg.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        admin_ico_bg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                adminMouseClicked(evt);
            }
        });
        mainLayout.add(admin_ico_bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 110, 100));

        doc_ico_bg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        doc_ico_bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/circle_bg_green_02.png"))); // NOI18N
        doc_ico_bg.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        doc_ico_bg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                docIconMouseClicked(evt);
            }
        });
        mainLayout.add(doc_ico_bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 110, 100));

        recep_ico_bg.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        recep_ico_bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/drawable/circle_bg_green_02.png"))); // NOI18N
        recep_ico_bg.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        recep_ico_bg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                receptionistMouseClicked(evt);
            }
        });
        mainLayout.add(recep_ico_bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 160, 110, 100));
    ...
    private javax.swing.JLabel admin_ico_bg;
    private javax.swing.JLabel closeBtn;
    private javax.swing.JLabel doc;
    private javax.swing.JLabel docIcon;
    private javax.swing.JLabel doc_ico_bg;
    ...
    private javax.swing.JLabel recep_ico_bg;
